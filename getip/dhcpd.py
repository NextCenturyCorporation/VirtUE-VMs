...
def parse_leases_file(leases_file_name = LEASE_FILE_PATH):
        with open(leases_file_name, 'r') as leases_file:
                return parse_leases(leases_file)


def parse_leases(leases_file):
        valid_keys = {
